...
echo "$str1"
"/opt/netiq/common/jre/bin/java" -classpath "/opt/netiq/idm/apps/IDMReporting/DbSchema-DCS.jar:__RPT_DATABASE_JDBC_DRIVER_JAR__:/opt/netiq/idm/apps/IDMReporting/liquibase.jar:__RPT_CONFIG_HOME_PERSIST_JAR__" liquibase.integration.commandline.Main --url="__RPT_DATABASE_CONNECTION_URL__" --logFile="/var/opt/netiq/idm/log/RptDb-01-log.out" --logLevel=info --outputDefaultCatalog=true --outputDefaultSchema=true --changeLogFile=IdmDcsDataDropViews.xml --defaultSchemaName=idm_rpt_cfg --username=idm_rpt_cfg --password=${RPT_DATABASE_SHARE_PASSWORD}  clearCheckSums 
...
echo "$str1"
"/opt/netiq/common/jre/bin/java" -Ddefault.datasource.name="Installed Database" -classpath "/opt/netiq/idm/apps/IDMReporting/DbSchema.jar:__RPT_DATABASE_JDBC_DRIVER_JAR__:/opt/netiq/idm/apps/IDMReporting/liquibase.jar:__RPT_CONFIG_HOME_PERSIST_JAR__" liquibase.integration.commandline.Main --url="__RPT_DATABASE_CONNECTION_URL__" --logFile="/var/opt/netiq/idm/log/RptDb-02-log.out" --logLevel=info --outputDefaultCatalog=true --outputDefaultSchema=true --changeLogFile=IdmRptCfgSchemaChangeLog.xml --defaultSchemaName=idm_rpt_cfg --username=idm_rpt_cfg --password=${RPT_DATABASE_SHARE_PASSWORD}  clearCheckSums 
...
echo "$str1"
"/opt/netiq/common/jre/bin/java" -classpath "/opt/netiq/idm/apps/IDMReporting/DbSchema-DCS.jar:/opt/netiq/idm/apps/IDMReporting/DbSchema.jar:__RPT_DATABASE_JDBC_DRIVER_JAR__:/opt/netiq/idm/apps/IDMReporting/liquibase.jar:__RPT_CONFIG_HOME_PERSIST_JAR__" liquibase.integration.commandline.Main --url="__RPT_DATABASE_CONNECTION_URL__" --logFile="/var/opt/netiq/idm/log/RptDb-06-log.out" --logLevel=info --outputDefaultCatalog=true --outputDefaultSchema=true --changeLogFile=IdmDcsDataGrantPrivileges.xml --defaultSchemaName=idm_rpt_cfg --username=idm_rpt_cfg --password=${RPT_DATABASE_SHARE_PASSWORD}  clearCheckSums 
