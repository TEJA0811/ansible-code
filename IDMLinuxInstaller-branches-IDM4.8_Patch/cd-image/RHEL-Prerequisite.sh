...
#A=`echo libXrender.i686 libXau.i686 libxcb.i686 libX11.i686 libXext.i686 libXi.i686 libXtst.i686 glibc.x86_64 libstdc++.i686 libstdc++.x86_64 libgcc.x86_64 compat-libstdc++-33.x86_64 compat-libstdc++-33.x86_64 unzip gettext ksh`
#export A package > /dev/null
#pre-requisite
unset A B C D E
package=`echo Identity Manager`
A=`echo glibc.x86_64 libstdc++.x86_64 libgcc.x86_64 compat-libstdc++-33.x86_64 compat-libstdc++-33.x86_64 net-tools.x86_64 zip unzip gettext ksh bc lsof`
export A package > /dev/null
pre-requisite
unset A B C D E
...
if [ -f /etc/redhat-release ] ; then
	...
	then
	  A=`echo gettext.x86_64 libstdc++.x86_64 compat-libstdc++-33.x86_64 dnf-utils createrepo_c yum`
	else
	  A=`echo gettext.x86_64 libstdc++.x86_64 compat-libstdc++-33.x86_64 yum-utils createrepo yum`
	fi
...
A=`echo glibc.i686 libXau.i686 libxcb.i686 libX11.i686 libXext.i686 libXi.i686 libXtst.i686 libgcc.i686 libXrender.i686 libstdc++.x86_64 compat-libstdc++-33.i686 compat-libstdc++-33.x86_64 lsof`
export A package > /dev/null
pre-requisite
if [ ! -f /etc/redhat-release ] ; then
	unset A B C D E
