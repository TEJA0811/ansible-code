...
-- Access-Requests-by-Recipient_4.8.3.0-pg-idmrpt_events_v2.sql
...
-- Access-Requests-by-Recipient_4.8.3.0-pg-idmrpt_trustview_v.sql
...
-- Access-Requests-by-Requester_4.8.3.0-pg-idmrpt_events_v2.sql
...
-- Access-Requests-by-Resource_4.8.3.0-pg-idmrpt_events_v2.sql
...
-- Authentication-by-Server_4.8.3.0-pg-idmrpt_auth_by_serv_v.sql
...
-- Authentication-by-User_4.8.3.0-pg-idmrpt_auth_by_user_v.sql
...
-- Available-Permissions-Current-State_4.8.3.0-pg-idmrpt_prd_summary_cs_v.sql
...
-- Available-Permissions-Current-State_4.8.3.0-pg-idmrpt_resources_summary_v.sql
...
-- Available-Permissions-Current-State_4.8.3.0-pg-idmrpt_role_cs_summary_v.sql
...
-- Available-Permissions-Current-State_4.8.3.0-pg-idmrpt_role_res_prd_count_v.sql
...
-- Correlated-Resource-Assignment-Events-by-User_4.8.3.0-pg-idmrpt_corr_res_assignment_v.sql
...
-- Database-Statistics_4.8.3.0-pg-idmrpt_events_v2.sql
...
-- Database-Statistics_4.8.3.0-pg-idmrpt_system_info_v.sql
...
-- Identity-Vault-User-Report_4.8.3.0-pg-idmrpt_identity_photo_v.sql
...
-- Identity-Vault-User-Report-Current-State_4.8.3.0-pg-idmrpt_identity_info_v.sql
...
-- Identity-Vault-User-Report-Current-State_4.8.3.0-pg-idmrpt_identity_photo_v.sql
...
-- Object-Provisioning_4.8.3.0-pg-idmrpt_object_prov_v.sql
...
-- Password-Resets_4.8.3.0-pg-idmrpt_pass_reset_v.sql
...
-- Resource-Assignments-by-Resource_4.8.3.0-pg-idmrpt_res_approvals_v.sql
...
-- Resource-Assignments-by-Resource-Current-State_4.8.3.0-pg-idmrpt_approver_approval_v.sql
...
-- Resource-Assignments-by-Resource-Current-State_4.8.3.0-pg-idmrpt_resource_info_v.sql
...
-- Self-Password-Changes_4.8.3.0-pg-idmrpt_self_pass_change_v.sql
...
-- User-Entitlements_4.8.3.0-pg-idmrpt_events_v2.sql
...
-- User-Password-Change-Events-Summary_4.8.3.0-pg-idmrpt_events_v2.sql
...
-- User-Password-Change-Events-Summary_4.8.3.0-pg-idmrpt_password_summary_v.sql
...
-- User-Password-Changes-within-the-Identity-Vault_4.8.3.0-pg-idmrpt_user_events_v2.sql
...
CASE
WHEN event.sun IS NOT NULL THEN id_acct.idv_acct_user::text = lower(event.sun::text)
ELSE 
CASE
...
CASE
    ...
    CASE
        ...
        ELSE 
		CASE 
		    WHEN event.rv35 IS NOT NULL THEN id_acct.idv_acct_domain::text = lower(event.rv35::text)
...
-- User-Status-Changes-within-the-Identity-Vault_4.8.3.0-pg-idmrpt_user_events_v2.sql
...
-- User-Status-Changes-within-the-Identity-Vault_4.8.3.0-pg-idmrpt_user_status_v.sql
