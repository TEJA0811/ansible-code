...
echo "   <h2>Remote loader jars version check</h2>
...
#echo "BVT,$total,$pass,$fail,$unknown" >>rlbvt_res
echo "Remote-Loader $total $pass $fail $unknown" > bvt_result
